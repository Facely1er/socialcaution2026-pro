...
const AssessmentExposure = () => {
  const navigate = useNavigate();

  return (
    <>
      <SEOHead
        title="Digital Privacy Risk Assessment - SocialCaution"
        description="Evaluate your digital privacy vulnerabilities and social footprint"
        keywords="privacy assessment, digital privacy, risk assessment"
      />
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  Evaluate your digital privacy vulnerabilities and social footprint
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-800 dark:text-blue-200 text-sm">
                    The full Digital Privacy Risk Assessment is available in our Standard version. 
...
export default AssessmentExposure;
