...
const Alerts = () => {
  ...
  return (
    <>
      <SEOHead
        title="Caution Alerts - SocialCaution"
        description="Stay informed about privacy threats, data breaches, and security alerts"
        keywords="privacy alerts, security alerts, data breaches"
      />
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  Stay informed about privacy threats, data breaches, and security alerts
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">
                    Alerts Available in Standard Version
                  </h3>
                  <p className="text-blue-800 dark:text-blue-200 text-sm">
                    Personalized privacy alerts and notifications are available in our Standard version. 
