...
const AssessmentFull = () => {
  ...
  return (
    <>
      <SEOHead
        title="Complete Privacy Assessment - SocialCaution"
        description="Comprehensive privacy evaluation and persona detection"
        keywords="privacy assessment, complete assessment, privacy evaluation"
      />
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  Comprehensive privacy evaluation and persona detection
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-800 dark:text-blue-200 text-sm">
                    The full Complete Privacy Assessment is available in our Standard version. 
