...
const AssessmentPrivacyRights = () => {
  const navigate = useNavigate();

  return (
    <>
      <SEOHead
        title="Privacy Rights Assessment - SocialCaution"
        description="Evaluate your understanding of GDPR, CCPA, and other privacy rights"
        keywords="privacy rights, GDPR, CCPA, privacy assessment"
      />
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  Evaluate your understanding of GDPR, CCPA, and other privacy rights
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-800 dark:text-blue-200 text-sm">
                    The full Privacy Rights Assessment is available in our Standard version. 
...
export default AssessmentPrivacyRights;
